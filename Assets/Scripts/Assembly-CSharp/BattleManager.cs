	...
	public virtual void AdvancePlayerTurn()
	{
		...
		else
		{
				...
				else
				{
					...
					if (gm.GetItem(partySelections[niceActIndex][2]) == 45)
					{
						...
						if (num12 == num13)
						{
							...
							string[] array4 = new string[6] { "RED", "BLUE", "GREEN", "ORANGE", "CYAN", "YELLOW" };
							int num15 = niceActIndex;
							if (miniPartyMember > 0)
							{
								num15 = 2 + miniPartyMember;
							}
							string text7 = "* " + PARTYMEMBER_NAMES[num15] + " plays";
							if (num15 == 0)
							{
								text7 = "* You play";
							}
							diag = new string[1] { text7 + " a WILD REVERSE.\n* Turn order has been reversed!\n* The color changes to " + array4[soul.GetComponent<SOUL>().GetSOULMode()] + "!" };
						}
						else
						{
							flag9 = false;
			...
			else if (partySelections[niceActIndex][1] == 6 && niceActIndex == 0)
			{
				...
				{
					int num17 = 15;
					diag = new string[1] { "* Paula tried LIFEUP...\n" + Items.GetRecoveryString(partySelections[niceActIndex][0], num17) };
